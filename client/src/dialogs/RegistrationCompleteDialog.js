        ...
        return (
            <Grid className={"registrationCompleteDialogContentGrid"} container>
                ...
                <Grid className={"line iconSection"} item>
                    <Image className={"buttonIcon"} src={require('images/mail.png')} scale={0.2}/>
                </Grid>
                ...
                <Grid className={"line returnToHomepageSection"} item>
                    <Link to='/'>
                        <SubmitButton onClick={this.onBackClick} className={"returnToHomepageButton"} text={"Return to homepage"} />
                    </Link>
