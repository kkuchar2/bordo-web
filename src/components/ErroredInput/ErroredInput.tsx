...
import {FieldError} from "components/Forms/FormErrors/FieldError";
...
export const ErroredInput = (props: WrappedInputProps & InputProps & BaseComponentProps) => {
    const {t} = useTranslation();

    const {id, theme, errors, marginTop, ...rest} = props;
