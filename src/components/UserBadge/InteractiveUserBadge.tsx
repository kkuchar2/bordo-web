...
import { HoverMenuItem, HoverMenuItemProps } from '@/components/MainMenu/HoverMenu/HoverMenuItem';
import { HoverMenuLinkItem, HoverMenuLinkItemProps } from '@/components/MainMenu/HoverMenu/HoverMenuLinkItem';
...
type BadgeMenuItem = {
    ...
    props: HoverMenuItemProps | HoverMenuLinkItemProps;
        ...
        {showMenu && <div className={'absolute right-[20px] top-[110%] z-10 w-full animate-navbarMenu overflow-hidden rounded-lg bg-neutral-700 opacity-0 shadow-lg shadow-black/20'}>
            {
                badgeMenuItems.map((item, index) => {
                    ...
                    return <Component key={index} onClick={onLinkClick} {...item.props} />;
                })
            }
