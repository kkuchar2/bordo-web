...
export { default as navbarReducer } from 'appRedux/reducers/application/navbarSlice';
export * from 'appRedux/reducers/application/navbarSlice';
...
export { default as appReducer } from 'appRedux/reducers/application/appSlice';
export * from 'appRedux/reducers/application/appSlice';
